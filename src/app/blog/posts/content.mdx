...
Replace the `public/images/my.jpg` file with your own avatar image. It is used on the `/about` page as well as on the dynamically generated `open-graph` images.
...
`const home = {
    label: "Home",
    title: "Dwaipayan Dasgupta's Portfolio",
    description: "Portfolio website showcasing my work as a Design Engineer",
    headline: <>Design engineer and builder</>,
    subline: (
      <>
        I'm Dwaipayan, a design engineer at <InlineCode>FLY</InlineCode>, where I craft intuitive
