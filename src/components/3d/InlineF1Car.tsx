...
export default function InlineF1Car() {
  return (
    <div style={{ 
      ...
      <Canvas camera={{ position: [6, 3, 6], fov: 45 }} gl={{ antialias: true, toneMapping: THREE.ACESFilmicToneMapping, toneMappingExposure: 1.1 }}>
        <ambientLight intensity={0.6} />
        {/* 3 point lighting setup for showroom look */}
        <directionalLight position={[10, 10, 5]} intensity={1.5} castShadow />
        <spotLight position={[-10, 10, -10]} intensity={2.5} color="#00f3ff" angle={0.5} penumbra={1} />
